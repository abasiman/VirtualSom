  ...
  return (
    <div className="relative mt-20 border-b border-neutral-800 min-h-[800px]:">
        <div className="text-center">
            <span className="bg-neutral-900 text-orange-500 uppercase rounded-full h-6 py-1 px-2
            text-sm font-medium">feature
            </span>
        ...
        <div className="flex lg:px-32 flex-wrap mt-10 lg:mt-20">
